    ...
    <div class="flex min-h-screen bg-base-300">
      ...
      <aside class="sidebar">
        <div class="mb-8">
          ...
          <p class="text-sm text-base-content/60">PT Cross-Seeding Tool</p>
        </div>
        ...
        <ul class="menu menu-lg gap-1">
          ...
          <li>
            <A href="/clients" activeClass="active">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          ...
          <li>
            <A href="/sites" activeClass="active">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          ...
          <li>
            <A href="/index" activeClass="active">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          ...
          <li>
            <A href="/reseed" activeClass="active">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
